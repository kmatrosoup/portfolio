...
float
aqua::easing::
InElastic(float time, float finish_time, float min, float max)
{
    static const float c = (2.0f * PI) / 3.0f;
    ...
    float x = time / finish_time;
    float y = powf(2.0f, 10.0f * x - 10.0f) * sinf((x * 10.0f - 10.75f) * c);
...
float
aqua::easing::
OutElastic(float time, float finish_time, float min, float max)
{
    static const float c = (2.0f * PI) / 3.0f;
    ...
    float x = time / finish_time;
    float y = powf(2.0f, -10.0f * x) * sinf((x * 10.0f - 0.75f) * c) + 1.0f;
    return min + (max - min) * y;
}
...
float
aqua::easing::
InOutElastic(float time, float finish_time, float min, float max)
{
    static const float c = (2.0f * PI) / 4.5f;
    ...
    float x = time / finish_time;
    float y = (x < 0.5f) ?
        -powf(2.0f, 20.0f * x - 10.0f) * sinf((20.0f * x - 11.125f) * c) / 2.0f :
        powf(2.0f, -20.0f * x + 10.0f) * sinf((20.0f * x - 11.125f) * c) / 2.0f + 1.0f;
    return min + (max - min) * y;
}
