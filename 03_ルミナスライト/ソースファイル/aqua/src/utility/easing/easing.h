...
namespace aqua
{
    ...
    namespace easing
    {
         ...
         *  @param[in]  max         最大値
         */
        float OutElastic(float time, float finish_time, float min = 0.0f, float max = 1.0f);
         ...
         *  @param[in]  max         最大値
         */
        float InElastic(float time, float finish_time, float min = 0.0f, float max = 1.0f);
         ...
         *  @param[in]  max         最大値
         */
        float InOutElastic(float time, float finish_time, float min = 0.0f, float max = 1.0f);
    }
}
